...
The result is stored in dictionary, pickled and saved on disk. The dictionary ocntains the the strings as the keys and the values are dataframes containing the 5 best matches through CombinedSimilarity, the similarity score and the corresponding indices.  
